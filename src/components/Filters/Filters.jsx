...
const Filters = ({ showFilters, className }) => {
  ...
  return (
    <Collapse
      show={showFilters}
      onExiting={handleSubmit(onSubmit)}
    >
      <Stack
        gap={0.5}
        padding={1}
        ...
        >
          ...
          <EntryTypeSelect
            ...
            onChange={(field, value) =>
              onSearchParamFieldValueChanged(field, value, true)
            }
          />
          <LogbooksMultiSelect
            control={control}
          ...
          <WizardDateInput
            ...
            onChange={(field, val) =>
              onSearchParamFieldValueChanged(field, val, true)
            }
            DatePickerProps={{
              disableFuture: true
            }}
          ...
          <RadioInput
            ...
            control={control}
            defaultValue={
              searchPageParams.sort || customization.defaultSortDirection
            }
            options={[
              {
                label: "descending",
