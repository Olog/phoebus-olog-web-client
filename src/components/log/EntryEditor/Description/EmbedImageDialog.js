...
const EmbedImageDialog = ({
  ...
  const isPositiveInteger = (value) => {
    return Number.isInteger(value) && parseInt(value, 2) > 0;
  };
        ...
        >
          ...
          <TextInput
            ...
            rules={{
              validate: {
                isPositive: (val) =>
                  isPositiveInteger(val) || "Width must be a positive number"
              }
            }}
          />
          <TextInput
            ...
            rules={{
              validate: {
                isPositive: (val) =>
                  isPositiveInteger(val) || "Height must be a positive number"
              }
            }}
          />
        </Stack>
