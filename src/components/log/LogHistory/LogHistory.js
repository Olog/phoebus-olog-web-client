    ...
    return (
        <Stack padding={1}>
            <Stack flexDirection="row" justifyContent="space-between" alignItems="center">
                <Typography component="h1" variant="h2">Log History</Typography>
                <DownloadButton {...{currentLog, logHistory}} />
            </Stack>
            <Stack>
                <Typography component="h2" variant="h4">Current Entry</Typography>
                <Box padding={1}>
                    <LogEntrySingleView currentLogEntry={currentLog} />
                </Box>
                <Typography component="h2" variant="h4">Previous Edits</Typography>
                <Stack>
