...
import { FormControl, FormControlLabel, FormHelperText, FormLabel, Radio, RadioGroup, styled } from "@mui/material";
 ...
 */
const RadioInput = styled(({name, label, options, control, rules, defaultValue, onChange, className, ...props}) => {
    ...
    const error = fieldState.error ? `Error: ${fieldState?.error?.message}` : null;
