...
export const FileImage = ({ alt, className, ...props }) => {
    return (
        <Stack
            ...
            {...props}
        >
            <Box className="file-overlay" sx={{ display: "none", position: "absolute", width: "100%", height: "100%", background: "white", opacity: 0.6, zIndex: 1 }} />
            <DownloadIcon className="file-overlay" sx={{ color: "gray", width: "30px", height: "30px", position: "absolute", left: "33px", bottom: "25px", zIndex: 2, }} />
            <InsertDriveFileIcon titleAccess={"file: " + alt} fontSize="inherit" sx={{ perserveAspectRatio: "none" }} />
        </Stack>
    )
}
