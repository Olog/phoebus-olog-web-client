...
test('Image markup conversion', () => {
    ...
    expect(remarkable.render(imageString)).toBe('<p><img src="http=whatever" alt=""></p>\n');
    
    imageString = '![](http=whatever){width=640 height=480}foobar';
    expect(remarkable.render(imageString)).toBe('<p><img src="http=whatever" alt="" width=640 height=480>foobar</p>\n');
    
    imageString = '![](http=whatever){WIDTH=640 HEIGHT=480}';
    expect(remarkable.render(imageString)).toBe('<p><img src="http=whatever" alt="" width=640 height=480></p>\n');
    
    imageString = '![](http=whatever){width=640 height=480} foobar';
    expect(remarkable.render(imageString)).toBe('<p><img src="http=whatever" alt="" width=640 height=480> foobar</p>\n');
    
    imageString = '![](http=whatever){width=640 height=480}![](http=whatever){width=640 height=480}';
    expect(remarkable.render(imageString)).toBe('<p><img src="http=whatever" alt="" width=640 height=480><img src="http=whatever" alt="" width=640 height=480></p>\n');
    
    imageString = 'preceding text ![](http=whatever){width=640 height=480} intermediate text ![](http=whatever){width=640 height=480} trailing text';
    expect(remarkable.render(imageString)).toBe('<p>preceding text <img src="http=whatever" alt="" width=640 height=480> intermediate text <img src="http=whatever" alt="" width=640 height=480> trailing text</p>\n');
...
test('Image markup conversion, no image', () => {
    ...
    expect(remarkable.render(markupString)).toBe('<p><strong>This does not contain an image</strong></p>\n');
});

test('Macth image markup', () => {
    expect(matchImage("![](http://foo.bar)")).toBeDefined();
    expect(matchImage("preceding text ![](http://foo.bar) trailing text")).toBeDefined();
